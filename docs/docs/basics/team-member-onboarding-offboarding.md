# Supervisor Onboarding & Offboarding Checklists
...
* "Perform DTS onboarding tasks," to assign to the new team member once they have a Github username. In the meantime you can direct them to the [Welcome to DTS](welcome-to-dts.md) Gitbook page. &#x20;
...
* [ ] Submit a [New Employee Request Form](https://atx.servicenowservices.com/sp?id=sc_cat_item_guide\&sys_id=b714eb12db7a3f0021ccef92ca961972) to create a CoA network account, eAccess PIN/HR Portal, and phone. Under "Network Account Information," write \
  ...
  `Distribution lists: @austintexas.gov and TPWEmployees@austintexas.gov`.
...
Refer to the [DTS offboarding issue template](https://github.com/cityofaustin/atd-data-tech/issues/new?template=-all-purpose--offboarding-tasks.md).&#x20;
