...
We've been working hard to improve visibility into our work. Going forward, the below project list will include all active projects, as well as any projects whose status has changed. We'll be announcing additional ways to keep track of our work in the near future.
...
Development work is complete. Next week we will begin piloting a beta version of the app with three traffic signal technicians.
...
Test editing revealed that the relationship classes needed to be modified, so the schemas are being reworked. We've also determined that, due to enhanced editing capabilities in regards to related data, the new process will move directly into ArcGIS Pro.
...
The first phase of the project is 80% complete. Approximately 15 million [GRIDSMART traffic count records](https://data.austintexas.gov/Transportation-and-Mobility/Camera-Traffic-Counts/sh59-i6y9 )were published from the data lake to the open data portal last week.
...
After pitching at Github's Open Source for Good volunteer event, we got a small but mighty team of Hubbers to help move this important work forward. 🙌 

### [Vision Zero Citation Reportin App](https://github.com/cityofaustin/atd-data-tech/issues/145) | In Progress 🛠️
...
After a 6-month hiatus, AECOMM was authorized to proceed in June. Work is 20% complete. ETA June 2020.
...
On 8/16 the Case Management Governing Board voted to approve a request to engage Unisys for this work, for up to $400,00, funded by ATD.
...
After an initial planning meeting, we have placed this project on hold until additional project management resources are available. Expect to resume early Q1 FY20.
