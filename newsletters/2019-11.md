...
We're happy to announce that Alan De Anda has been promoted to IT Geospatial Analyst Sr. Alan will continue to serve as our resident expert on all things related to active transportation, and is currently leading projects related to bicycle rack data collection, the citywide print bike map, and our upcoming street data mapathon.
